...
export const copy = {
  ...
  billing: {
    ...
    firstRow: "Aucune ligne encore. « Ajouter une ligne » pour commencer.",
    titlePlaceholder: "Nouvelle ligne…",
    keysHint: "Entrée pour descendre, Maj+Entrée pour monter, Échap pour annuler. Montant vide = heures × taux.",
